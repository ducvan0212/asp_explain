...
then
  clingo ${ROBOT_DOMAIN_FACT_IN_WRAPPER} ${HUMAN_DOMAIN_FACT_IN_WRAPPER} compute_pi_a_minus_pi_h.lp --outf=0 -V0 --out-atomf=%s. --quiet=1,2,2 | head -n1 > ${ROBOT_MODEL_MINUS_HUMAN_DOMAIN}
